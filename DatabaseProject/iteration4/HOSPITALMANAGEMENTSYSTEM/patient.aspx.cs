...
namespace HOSPITALMANAGEMENTSYSTEM
{
    public partial class patient : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                Label1.Text = " Welcome " + Session["FirstName"] + " " + Session["LastName"];

        }

        protected void Button1_Click(object sender, EventArgs e)
        {
            string Appointments = "Select a.AppointmentID,e.FirstName + ' ' + e.LastName as DoctorName, pa.FirstName + ' ' + pa.LastName as PatientName,adr.City + ' ' + adr.State + ' ' + CAST(adr.ZipCode AS varchar) as Patient_Address,p.Medication,a.Date From Appointment a left join Doctor d on a.DoctorID = d.DoctorID inner join Employee e on e.EmployeeID = d.DoctorID left join Prescription p on a.AppointmentID = p.AppointmentID left join Patient pa on pa.PatientID = a.PatientID left join Addresses adr on adr.AddressID = pa.AddressID where pa.PatientID =" + Session["PatientID"];
        ...
        protected void Button5_Click(object sender, EventArgs e)
        {
            ...
            string cmd = "Select * From Find_Doctors";
            string connectionString = ConfigurationManager.ConnectionStrings["conStr"].ToString();
